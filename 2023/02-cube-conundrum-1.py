...
class Solution():
    ...
    def get_solution(self):
        ids = []
        for colors in self.game_colors:
            if colors["red"] <= self.loaded_colors["red"] and colors["green"] <= self.loaded_colors["green"] and colors["blue"] <= self.loaded_colors["blue"]:
                ids.append(colors["game_id"])
        answer = sum(ids)
        print(answer)
